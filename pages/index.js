            ...
            <div className="flex flex-wrap items-end pb-4">
              <div className="w-full md:w-1/3 lg:w-1/4 order-2 md:order-1">
                <div className="max-w-sm md:max-w-xs">
                  ...
                  <a href="#" className="underline mb-1 block text-lg md:text-2xl tracking-tight font-serif uppercase leading-tight hover:text-red">
                    Instagram
                  </a>
                  <a href="#" className="underline mb-1 block text-lg md:text-2xl tracking-tight font-serif uppercase leading-tight hover:text-red">Dribbble</a>
                  <a href="#" className="underline block text-lg md:text-2xl tracking-tight font-serif uppercase leading-tight hover:text-red">Email</a>
                </div>
              </div>
              ...
              <div className="w-full md:w-1/2 lg:w-2/3 md:ml-auto order-1 md:order-2 mb-16 md:mb-0">
                <ul className="text-sm md:text-lg tracking-tight font-book leading-none border-t border-black">
                  <li className="mb-0 py-3 flex flex-wrap border-b border-black">
                    <span className="block">Awwwards</span><span className="block text-right ml-auto font-serif italic">Site Of The Day</span>
                  </li>
                  <li className="mb-0 py-3 flex flex-wrap border-b border-black">
                    <span className="block align-top">Awwwards <span className="text-[7px] md:text-2xs align-top">(2)</span></span><span className="block text-right ml-auto font-serif italic">Mobile Of The Day</span>
                  </li>
                  <li className="mb-0 py-3 flex flex-wrap border-b border-black">
                    <span className="block align top">CSSDA <span className="text-[7px] md:text-2xs align-top">(3)</span></span><span className="block text-right ml-auto font-serif italic">Site Of The Day</span>
                  </li>
                  <li className="mb-0 py-3 flex flex-wrap border-b border-black">
                    <span className="block">CSSDA</span><span className="block text-right ml-auto font-serif italic">Innovation, Interface, Experience</span>
                  </li>
                  <li className="mb-0 py-3 flex flex-wrap border-b border-black">
                    <span className="block align-top">Admire The Web <span className="text-[7px] md:text-2xs align-top">(3)</span></span><span className="block text-right ml-auto font-serif italic">Featured Site</span>
                  </li>
                  <li className="mb-0 py-3 flex flex-wrap border-b border-black">
                    <span className="block align-top">Mindsparkle <span className="text-[7px] md:text-2xs align-top">(3)</span></span><span className="block text-right ml-auto font-serif italic">Site Of The Day</span>
                  </li>
                  <li className="mb-0 py-3 flex flex-wrap border-b border-black">
                    <span className="block">Typewolf</span><span className="block text-right ml-auto font-serif italic">Featured Site</span>
                  </li>
                  <li className="mb-0 py-3 flex flex-wrap border-b border-black">
                    <span className="block align-top">SiteInspire <span className="text-[7px] md:text-2xs align-top">(2)</span></span><span className="block text-right ml-auto font-serif italic">Featured Site</span>
                  </li>
                  <li className="mb-0 py-3 flex flex-wrap border-b border-black">
                    <span className="block">Codrops</span><span className="block text-right ml-auto font-serif italic">Site Of The Week</span>
                  </li>
                </ul>
              </div>
            </div>
