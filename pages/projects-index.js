...
export default function ProjectsIndex(initialData) {
          ...
          >
            <div className="relative">
              ...
              <motion.div variants={fade} className="flex flex-wrap py-5 mb-8 md:mb-12 xl:mb-16">
                <Link href="/">
                  <a className="items-center justify-end text-2xl lg:text-3xl font-book tracking-tighter leading-tight px-2 md:px-4 inline-block hover:text-red overflow-hidden">
              ...
              <div className="px-2 md:px-4">
                <motion.div variants={fade} className="flex flex-wrap border-b items-end border-black mb-4 md:mb-6 lg:mb-8">
                  <div className="w-1/2 md:w-1/4">
                    ...
                    <motion.span variants={reveal} className="block">(1)</motion.span></span>
                    <span className="block uppercase tracking-tight text-xs md:text-base lg:text-xl font-serif overflow-hidden"><motion.span variants={reveal} className="block">All Works</motion.span></span>
                  </div>

                  <span className="hidden md:block flex-1 uppercase tracking-tight text-xs md:text-base lg:text-xl font-serif overflow-hidden"><motion.span variants={reveal} className="block">{projects.length} Projects</motion.span></span>

                  <span className="hidden md:block w-1/4 ml-auto text-right uppercase tracking-tight text-xs md:text-base lg:text-xl font-serif overflow-hidden"><motion.span variants={reveal} className="block">2016—{new Date().getFullYear().toString().substr(-2)}</motion.span></span>
                </motion.div>
              </div>
            </div>
