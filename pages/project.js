        ...
        >
          <div className="h-[100vh] relative flex flex-wrap text-off-white">
            <motion.div variants={fade} className="relative z-20 pt-2 md:pt-3 flex flex-wrap w-full">
              ...
              <span className="block text-2xl lg:text-3xl font-serif italic tracking-tighter leading-tight px-2 md:px-4 ml-auto text-right"><span className="block md:inline-block">IJP—22</span> <span className="hidden md:inline-block">/</span> <span className="block md:inline-block">Paul Smith</span></span>
            </motion.div>

            <div className="relative overflow-hidden w-full self-end mt-auto mb-4">
              <motion.h1 variants={fade} className="text-[26vw] md:text-[30vw] md:ml-[-35%] relative z-20 font-display tracking-[-0.075em] md:whitespace-nowrap leading-negative">Paul Smith</motion.h1>
              ...
              <motion.div variants={fade} className="relative z-20 px-2 md:px-4 w-full">
                <ul className="text-sm md:text-lg tracking-tight font-book leading-none border-t border-off-white w-full">
                  <li className="mb-0 py-3 flex flex-wrap border-b border-off-white">
                    <span className="block">Client</span><span className="block text-right ml-auto font-serif italic">Paul Smith</span>
                  </li>
                  <li className="mb-0 py-3 flex flex-wrap border-b border-off-white">
                    <span className="block">Years</span><span className="block text-right ml-auto font-serif italic">2017—19</span>
                  </li>
                  <li className="mb-0 py-3 flex flex-wrap border-b border-off-white">
                    <span className="block">Disciplines</span><span className="block text-right ml-auto font-serif italic">Art Direction, Interactive</span>
                  </li>
                </ul>
              </motion.div>
            </div>
            ...
            <motion.div variants={noFade} className="absolute inset-0 z-0">
              <img src="/images/ps.jpg" className="w-full h-full object-cover object-center md:mb-3" alt="Change Me!" />
            </motion.div>
          </div>
